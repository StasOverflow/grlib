...
GrContextInit(tContext *pContext)
{
    ...
    pContext->sClipRegion.sXMax = DisplayWidthGet() - 1;
    pContext->sClipRegion.sYMax = DisplayHeightGet() - 1;
    ...
    pContext->ulGradient1  = 0;
    pContext->ulGradient2  = 0;
    pContext->pFont = 0;
